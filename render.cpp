...
void Scena::nastavi(int dolzinaOkna, int VisinaOkna, const char *naslovOkna)
{
    if (!glfwInit())
...
void Scena::spremeniBarvo(Barva barva)
{
    _barvaOdzadja = barva;
}
void Scena::dodajObljekt(const std::string &imeObjekta)
{
    tabObjektov.push_back(new Objekt(imeObjekta));
}
Objekt *Scena::poisciObjekt(const std::string &imeObjekta)
{
